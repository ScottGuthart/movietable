...
- **Context line:** With "Details under the title" on, a Caption line at weight 400 in Faded Ink sits under the title, truncated with the full text as its title attribute: the language (an em dash when IMDb lists none), the Oscar record ("10 Oscars, 17 nominations", "Nominated for 2 Oscars"), then up to two subgenres, or three when there is no record, as "English · 10 Oscars, 17 nominations · Biographical, Flashback". The scores stay in their columns. It lifts a compact row from 41px to 49px and a comfortable row from 48px to 60px.
